...
CREATE TABLE `complexity` (
  `idcomplexity` int NOT NULL AUTO_INCREMENT,
  `complexity_name` varchar(60) NOT NULL,
  PRIMARY KEY (`idcomplexity`)
...
INSERT INTO `complexity` VALUES (22,'Средняя'),(23,'Легкая'),(25,'Сложная');
